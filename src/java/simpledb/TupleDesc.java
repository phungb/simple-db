...
public class TupleDesc implements Serializable {
    ...
    public static TupleDesc merge(TupleDesc td1, TupleDesc td2) {
        // some code goes here
        int newLength = td1.items.size() + td2.items.size();
        Type[] typeAr = new Type[newLength];
        String[] fieldAr = new String[newLength];
        ...
        for (int i = td1.items.size(); i < newLength; i++) {
            typeAr[i] = td2.items.get(i - td1.items.size()).fieldType;
            fieldAr[i] = td2.items.get(i - td1.items.size()).fieldName;
        }
    ...
    public boolean equals(Object o) {
        ...
        for (int i = 0; i < t.numFields(); i++) {
            if (!t.items.get(i).fieldType.equals(this.items.get(i).fieldType)) {
                return false;
            }
        }
        return true;
