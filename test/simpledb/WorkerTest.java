...
public class WorkerTest extends ParallelTestBase {
    ...
    public static <P extends OpIterator> P serializePlan(P plan)
            throws Exception {
    ...
    public void checkExchangeOperatorLocalization(OpIterator plan, Worker worker)
            throws Exception {
        if (plan == null)
            return;
    ...
    public void queryLocalizationTest() throws Exception {
        ...
        OpIterator serializedPlan = serializePlan(plan);
    ...
    public void workerQueryExecutionTest() throws Exception {
        ...
        TableStats.computeStatistics();
        Parser p = new Parser();
        OpIterator localPlan = p.generateLogicalPlan(tid,
